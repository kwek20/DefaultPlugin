...
public class GhostFactory {
    ...
    */
    private String GHOST_TEAM_NAME = "Ghosts";
    ...
    public GhostFactory(Plugin plugin, String teamName) {
        // Initialize
    	GHOST_TEAM_NAME+= teamName;
    	GHOST_TEAM_NAME = GHOST_TEAM_NAME.substring(0, 15);
